...
- U——中位数所在组的上限
- L——中位数所在的组的下限
- 这里的![1552302365295](C:\Users\57206\AppData\Roaming\Typora\typora-user-images\1552302365295.png)——所有的频数加起来除以2
-  **S**m-1——中位数所在组以下的累计次数
- Sm+1——中位数所在组以上的频数
- **f****m**——中位数所在组的个数
- d——组距
...
- 四分位数：25%，50%，75%，三个数据点
  ...
  - **孤立点**：通常是**挑选落在****第三个四分位数之上*或第一个四分位数之下至少1.5 x IQR的值

#### 五位概括

这个就是用中位数、四分位数、最大最小值描述
